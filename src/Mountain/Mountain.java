...
public class Mountain implements Comparator<Mountain>, Comparable<Mountain> {
    ...
    public Mountain(Integer id, Double hoehe, Double dominanz){
        this.id = id;
        this.hoehe = hoehe;
   ...
   @Override
    public int compareTo(Mountain o) {
        return this.compare(this.compareTo(Mountain.class.));
    }

    @Override
    public void compare(String, Mountain) {
        Collections.sort(bergName, (o1, o2)-> bergName.compareTo(bergName));
    }
    */
}
