...
public class MountainPM {
    ...
    private static final String MOUNTAIN_FILE_PATH = "./Ressources/data/mountains.csv";
    //TODO
     private static final String CANTON_FILE_PATH = "./Ressources/data/cantons.csv";
    ...
    private static boolean aMountainHasBeenRemoved = false;
    ...
    public MountainPM() throws IOException, URISyntaxException {
        filteredList = list = readCSVfile(MountainPM.class.getResource(MOUNTAIN_FILE_PATH).toURI() &&);
        filteredList = list = readCSVfile(MountainPM.class.getResource(CANTON_FILE_PATH).toURI());
    ...
    public String getValueAt(String value, Integer index, int col) {
        Mountain mountain = filteredList.get(index);
        switch (col) {
            case 0:
    ...
    public void setValueAt(String value, int index, int col) {
        ...
        switch (col) {
            ...
            case 5:
                ...
                break;
            case 6:
                mountain.setId(value);
            default:
                mountain.setBergName(value);
        }
        filteredList.set(index, mountain);
        notifyObservers();
    }
    ...
    public void setSearchValue(String searchValue) {
        if (searchValue.length() > 2) {
            ...
            this.filteredList = searchFilterModule.filter(searchValue);
            this.setSelectedMountainId(this.filteredList.get(0).getId());
        } else {
            this.searchValue = "";
